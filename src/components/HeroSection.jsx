  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative flex flex-col gap-8 justify-center items-center h-full w-full z-20">
          <div className="flex justify-center items-center">
            <img src={heroImage} alt="Popcorn-man image" className="h-32" />
            <h2 className="text-7xl font-extrabold text-gray-200 animate-pulse tracking-wide">
              POPCORNMOVIES
            </h2>
          </div>
          ...
          <div className="bg-[#1E293B] w-3/5 h-24 mt-12 md:left-28 sm:left-24 rounded-full flex gap-8 items-center">
            <FontAwesomeIcon
